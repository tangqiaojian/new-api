...
export const STATIC_I18N_KEYS = [
  ...
  // Dashboard analytics (some are passed to t() through section/chart configs)
  '{{count}} requests',
  '{{count}} subscriptions',
  '{{total}} records',
  '+{{count}} more models',
  ...
  'Daily Model Token Usage Trend',
  'Daily Subscription Token Usage Trend',
  'Daily Token Usage',
  'Daily Token Usage Details',
  ...
  'Every 30s',
  'Every 60s',
  'Failed to load subscription usage data',
  'Failed to load today model tokens',
  'Filter by channel',
  'Filter by model',
  'High usage (≥80%)',
  'In',
  'Include cache',
  'Model Request Count Ranking',
  'Model Token Distribution',
  'Model Token Ranking',
  'Model token stats will appear here after you make API calls today.',
  'Next Reset',
  'No subscription usage data',
  'No token usage today',
  'No user subscriptions found',
  'Number Format',
  'On this page',
  'Out',
  'Platform Subscription Model Distribution',
  'Platform Subscription Token Trend',
  'Platform-wide usage for today',
  'Precise',
  'Prompt Tokens',
  'Quota exhausted',
  'Quota resets',
  ...
  'Top Channels',
  'User subscription plan usage',
  'User Token Distribution',
  'User Token Ranking',
  'Your model token usage for today',

  // Request debug logging (settings/detail labels)
  'Record request debug data',
  ...
  // Dashboard time granularity (t(option.label))
  'Hour',
  'Day',
  'Week',

  // Subscription admin / channel pools
  'Channel Pools',
  'User Subscriptions',
  'Plan type',
  'User and channel',
